(() => {
  ...
  const p = l('ArrayBuffer'),
    ...
    S = l('FileList'),
    T = l('URLSearchParams'),
    [A, v, C, N] = ['ReadableStream', 'Request', 'Response', 'Headers'].map(l);
  ...
  const x =
    ...
    P = (e) => !d(e) && e !== x,
    U =
      ((F = 'undefined' != typeof Uint8Array && o(Uint8Array)),
      (e) => F && e instanceof F);
  var F;
  const L = l('HTMLFormElement'),
    ...
    q = l('AsyncFunction'),
    I =
      ((M = 'function' == typeof setImmediate),
      (z = b(x.postMessage)),
      M
        ? setImmediate
        : z
          ? ((H = `axios@${Math.random()}`),
            ...
            x.addEventListener(
              'message',
              ({ source: e, data: t }) => {
                e === x && t === H && J.length && J.shift()();
              },
              !1,
            ),
            (e) => {
              (J.push(e), x.postMessage(H, '*'));
            })
          : (e) => setTimeout(e));
  var M, z, H, J;
  const W =
      'undefined' != typeof queueMicrotask
        ...
        : ('undefined' != typeof process && process.nextTick) || I,
    $ = {
      isArray: f,
      isArrayBuffer: p,
      isBuffer: h,
      ...
      forEach: j,
      merge: function e() {
        const { caseless: t, skipUndefined: n } = (P(this) && this) || {},
          r = {},
          o = (o, s) => {
            const i = (t && _(r, s)) || s;
            w(r[i]) && w(o)
  ...
  class K extends Error {
    static from(e, t, n, r, o, s) {
      const i = new K(e.message, t || e.code, n, r, o);
      return ((i.cause = e), (i.name = e.name), s && Object.assign(i, s), i);
    }
  ...
  const Y = $.toFlatObject($, {}, null, function (e) {
            ...
            return (
              ...
              a.forEach(function (e, r) {
                !$.isUndefined(e) &&
                  null !== e &&
                  t.append(
                    !0 === i ? Q([n], r, s) : null === i ? n : n + '[]',
                    c(e),
                  );
              }),
              !1
            );
        return !!X(e) || (t.append(Q(o, n, s), c(e)), !1);
      }
      const u = [],
        f = Object.assign(Y, {
          defaultVisitor: l,
      ...
      return (
        (function e(n, r) {
          if (!$.isUndefined(n)) {
            ...
            (u.push(n),
              $.forEach(n, function (n, s) {
                !0 ===
                  (!($.isUndefined(n) || null === n) &&
                    o.call(t, n, $.isString(s) ? s.trim() : s, r, f)) &&
                  e(n, r ? r.concat(s) : [s]);
              }),
              u.pop());
          }
  ...
  const ie = class {
    ...
    fe =
      le &&
      (!ue || ['ReactNative', 'NativeScript', 'NS'].indexOf(ue.product) < 0),
    de =
      'undefined' != typeof WorkerGlobalScope &&
      self instanceof WorkerGlobalScope &&
      'function' == typeof self.importScripts,
    he = (le && window.location.href) || 'http://localhost',
    pe = { ...t, ...ce },
    me = function (e) {
      function t(e, n, r, o) {
        let s = e[o++];
        ...
        const i = Number.isFinite(+s),
          a = o >= e.length;
        return (
          (s = !s && $.isArray(r) ? r.length : s),
          a
            ? ($.hasOwnProp(r, s) ? (r[s] = [r[s], n]) : (r[s] = n), !i)
            : ((r[s] && $.isObject(r[s])) || (r[s] = []),
              t(e, n, r[s], o) &&
                $.isArray(r[s]) &&
                (r[s] = (function (e) {
                  const t = {},
        ...
        function (e, t) {
          ...
          if (o) {
            if (n.indexOf('application/x-www-form-urlencoded') > -1)
              return (function (e, t) {
                return Z(e, new pe.classes.URLSearchParams(), {
                  visitor: function (e, t, n, r) {
                    return pe.isNode && $.isBuffer(e)
  ...
  (Se.accessor([
    ...
    $.reduceDescriptors(Se.prototype, ({ value: e }, t) => {
  ...
  const Ce = class extends V {
    constructor(e, t, n) {
      (super(null == e ? 'canceled' : e, V.ERR_CANCELED, t, n),
  ...
  const je = (e, t, n = 3) => {
    ...
    Pe = pe.hasStandardBrowserEnv
      ...
      : () => !0,
    Ue = pe.hasStandardBrowserEnv
      ? {
          write(e, t, n, r, o, s, i) {
            if ('undefined' == typeof document) return;
            const a = [`${e}=${encodeURIComponent(t)}`];
            ($.isNumber(n) && a.push(`expires=${new Date(n).toUTCString()}`),
              $.isString(r) && a.push(`path=${r}`),
              $.isString(o) && a.push(`domain=${o}`),
              !0 === s && a.push('secure'),
              $.isString(i) && a.push(`SameSite=${i}`),
  ...
  const Le = (e) => (e instanceof Te ? { ...e } : e);
  function Be(e, t) {
    t = t || {};
    const n = {};
    function r(e, t, n, r) {
    ...
    return (
      $.forEach(Object.keys({ ...e, ...t }), function (r) {
        const s = c[r] || o,
          i = s(e[r], t[r], r);
        ($.isUndefined(i) && s !== a) || (n[r] = i);
      }),
      n
    );
  }
  const De = (e) => {
      ...
      if (
        ...
        (t.url = se(
          Fe(t.baseURL, t.url, t.allowAbsoluteUrls),
          e.params,
          e.paramsSerializer,
        )),
        a &&
      ...
      if (
        ...
        (r && $.isFunction(r) && (r = r(t)), r || (!1 !== r && Pe(t.url)))
      ) {
        const e = o && s && Ue.read(s);
        e && i.set(o, e);
      }
      return t;
    },
      ...
      function (e) {
        return new Promise(function (t, n) {
          ...
          let i,
            ...
            l,
            u,
            { responseType: f, onUploadProgress: d, onDownloadProgress: h } = r;
          function p() {
            (l && l(),
              u && u(),
          ...
          (m.open(r.method.toUpperCase(), r.url, !0),
            ...
            (m.onabort = function () {
              m &&
                (n(new V('Request aborted', V.ECONNABORTED, e, m)), (m = null));
            }),
            (m.onerror = function (t) {
              const r = t && t.message ? t.message : 'Network Error',
                o = new V(r, V.ERR_NETWORK, e, m);
            ...
            h && (([c, u] = je(h, !0)), m.addEventListener('progress', c)),
            d &&
              m.upload &&
              (([a, l] = je(d)),
      ...
      if (t || n) {
        ...
        const o = function (e) {
          if (!n) {
            ...
            r.abort(
              t instanceof V ? t : new Ce(t instanceof Error ? t.message : t),
            );
          }
        };
        let s =
          t &&
          setTimeout(() => {
            ((s = null), o(new V(`timeout of ${t}ms exceeded`, V.ETIMEDOUT)));
          }, t);
        const i = () => {
          e &&
            (s && clearTimeout(s),
    ...
    { isFunction: ze } = $,
    He = (({ Request: e, Response: t }) => ({ Request: e, Response: t }))(
      $.global,
    ),
    { ReadableStream: Je, TextEncoder: We } = $.global,
    $e = (e, ...t) => {
      try {
        return !!e(...t);
      } catch (e) {
    ...
    Ke = (e) => {
      e = $.merge.call({ skipUndefined: !0 }, He, e);
      const { fetch: t, Request: n, Response: r } = e,
        o = t ? ze(t) : 'function' == typeof fetch,
        s = ze(n),
        i = ze(r);
      if (!o) return !1;
      const a = o && ze(Je),
      ...
      const u =
        ...
        f = i && a && $e(() => $.isReadableStream(new r('').body)),
        d = { stream: f && ((e) => e.body) };
      o &&
      ...
      return async (e) => {
        ...
        let O = qe([l, h && h.toAbortSignal()], p),
          S = null;
        const T =
          O &&
          O.unsubscribe &&
        ...
        try {
          if (
            ...
            0 !==
              (A = await (async (e, t) => {
                const r = $.toFiniteNumber(e.getContentLength());
                return null == r
                  ? (async (e) => {
                      if (null == e) return 0;
                      if ($.isBlob(e)) return e.size;
                      if ($.isSpecCompliantForm(e)) {
                        const t = new n(pe.origin, { method: 'POST', body: e });
                        return (await t.arrayBuffer()).byteLength;
                      }
                      return $.isArrayBufferView(e) || $.isArrayBuffer(e)
                        ? e.byteLength
                        : ($.isURLSearchParams(e) && (e += ''),
                          $.isString(e) ? (await c(e)).byteLength : void 0);
                    })(t)
                  : r;
              })(g, a))
          ) {
            ...
            if (
              ...
              const [e, n] = _e(A, je(xe(b)));
              a = Me(t.body, 65536, e, n);
            }
          }
          ...
          S = s && new n(o, l);
          let h = await (s ? R(S, E) : R(o, l));
          const p = f && ('stream' === y || 'response' === y);
          if (f && (m || (p && T))) {
            const e = {};
            ['status', 'statusText', 'headers'].forEach((t) => {
              e[t] = h[t];
            });
            const t = $.toFiniteNumber(h.headers.get('content-length')),
              [n, o] = (m && _e(t, je(xe(m), !0))) || [];
            h = new r(
              Me(h.body, 65536, n, () => {
                (o && o(), T && T());
              }),
          ...
          y = y || 'text';
          let v = await d[$.findKey(d, y) || 'text'](h, e);
          return (
            !p && T && T(),
            await new Promise((t, n) => {
              Ne(t, n, {
                data: v,
                headers: Te.from(h.headers),
                status: h.status,
          ...
          if (
            ...
            throw Object.assign(new V('Network Error', V.ERR_NETWORK, e, S), {
              cause: t.cause || t,
            });
          throw V.from(t, t && t.code, e, S);
        }
      };
    },
    Ve = new Map(),
    Xe = (e) => {
      ...
      for (; c--; )
        ((i = s[c]),
          (a = l.get(i)),
          void 0 === a && l.set(i, (a = c ? new Map() : Ke(t))),
          (l = a));
      return a;
    },
    Ge = (Xe(), { http: null, xhr: ke, fetch: { get: Xe } });
  $.forEach(Ge, (e, t) => {
    if (e) {
      try {
    ...
    Ze = function (e, t) {
      ...
      for (let i = 0; i < n; i++) {
        ...
        if (
          ((r = e[i]),
          (o = r),
          !Ye(r) && ((o = Ge[(n = String(r)).toLowerCase()]), void 0 === o))
        )
  ...
  const st = {
      assertOptions: function (e, t, n) {
        ...
        for (; o-- > 0; ) {
          ...
          if (!0 !== n) throw new V('Unknown option ' + s, V.ERR_BAD_OPTION);
        }
      },
      validators: rt,
    },
  ...
  class at {
    ...
    getUri(e) {
      return se(
        Fe((e = Be(this.defaults, e)).baseURL, e.url, e.allowAbsoluteUrls),
        e.params,
        e.paramsSerializer,
      );
    }
  ...
  const dt = ft,
    ht = (function e(t) {
      const r = new ct(t),
        o = n(ct.prototype.request, r);
      return (
        $.extend(o, ct.prototype, r, { allOwnKeys: !0 }),
        $.extend(o, r, null, { allOwnKeys: !0 }),
        (o.create = function (n) {
          return e(Be(t, n));
        }),
        o
  ...
  ((ht.Axios = ct),
    ...
    (ht.mergeConfig = Be),
    (ht.AxiosHeaders = Te),
    (ht.formToJSON = (e) => me($.isHTMLForm(e) ? new FormData(e) : e)),
    (ht.getAdapter = Ze),
    (ht.HttpStatusCode = dt),
    (ht.default = ht),
    ht
